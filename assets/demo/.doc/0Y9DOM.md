...
The coulomb counter does not compensate for reduced LiPo capacity at low temperatures. Flights below 5°C report 20% remaining when the pack is actually near cutoff. A temperature-indexed discharge curve lookup is needed.

## Diagram

![diagram](assets/tiki-0y9dom.svg)
