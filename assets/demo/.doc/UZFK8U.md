...
The payload release servo oscillates ±3° under high-frequency vibration from the motors. This has caused two accidental payload releases during hover. A software low-pass filter on the PWM command and mechanical damping mount are under evaluation.

## Diagram

![diagram](assets/tiki-uzfk8u.svg)
