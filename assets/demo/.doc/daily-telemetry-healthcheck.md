...
A daily automated check verifies that the telemetry pipeline is healthy: NATS consumer lag, ingest service error rate, database replication status, and Grafana dashboard availability.

## Diagram

![diagram](assets/tiki-58drc1.svg)
