...
Operators can currently upload malformed waypoint files that crash the mission planner. The upload endpoint needs schema validation, geofence boundary checks, and altitude ceiling enforcement before accepting a mission plan.

## Diagram

![diagram](assets/tiki-9xuy41.svg)
