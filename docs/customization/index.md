...
tiki is built to be shaped around your team's workflow. Everything — statuses,
task types, views, keyboard shortcuts, custom fields, and automation rules — is
defined in plain YAML files that live alongside your project.

Start with the tutorial for a guided walkthrough, or jump straight to the
reference docs for the topic you need.
